...
import com.wallet.xcel.trustapp.entity.ApiErrorException;
                ...
                public void onNext(Response<EthplorerResponse> response) {
                    ...
                    if (body != null && body.error == null) {
                        ...
                        if (body != null) {
                            ...
                            observer.onError(new ApiErrorException(new ErrorEnvelope(C.ErrorCode.UNKNOWN, "Service not available")));
                        }
                    }
                }
