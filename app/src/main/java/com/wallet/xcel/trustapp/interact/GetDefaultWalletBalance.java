...
import com.wallet.xcel.trustapp.util.BalanceUtils;
...
import static com.wallet.xcel.trustapp.C.USD_SYMBOL;
import static com.wallet.xcel.trustapp.util.BalanceUtils.weiToEth;
    ...
    public Single<Map<String, String>> get(Wallet wallet) {
        return walletRepository.balanceInWei(wallet)
                .flatMap(ethBallance -> {
                    ...
                    balances.put(ethereumNetworkRepository.getDefaultNetwork().symbol, BalanceUtils.weiToEth(ethBallance, 5));
